...
​
        ...
        while q.size() > 0:
            ...
            # look at the last element in the path
            current_node = current_path[-1]
            # check if it has been visited
            if current_node not in visited:
                # add to the visited dictionary with the key being the user and the value being the path
                # this remembers the path so far
